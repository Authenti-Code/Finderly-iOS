...
enum constantsVaribales{
    ...
    static let profileLabelAry = ["Notification","About us","Contact us","Privacy policy","Saved Business","Reset password"]
    static let profileImgAry = ["notification-icon","about-icon","phone-icon","privacy-icon","savebusiness","savebusiness"]
